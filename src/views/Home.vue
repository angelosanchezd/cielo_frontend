        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 d-flex flex-column justify-content-center">
              <h1 data-aos="fade-up">
                We provide resources, visibility, and connections for established institutions and those who visit them.
              </h1>
      ...
      <section id="features" class="features">
        <div class="container" data-aos="fade-up">
              ...
              <div class="row align-self-center gy-4">
                <div class="col-md-6" data-aos="zoom-out" data-aos-delay="200">
                  <div class="feature-box d-flex align-items-center">
                    ...
                    <h3>View all office spaces in your area.</h3>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row feture-tabs" data-aos="fade-up">
            <div class="col-lg-6">
              <h3>Use the resources provided by established office spaces.</h3>

              <!-- Tabs -->
              <ul class="nav nav-pills mb-3">
                <li>
                  <a class="nav-link active" data-bs-toggle="pill" href="#tab1">Spaces</a>
                </li>
                <!-- <li>
              ...
              <div class="tab-content">
                <div class="tab-pane fade show active" id="tab1">
                  <p>
                    As we shift to working from home, we miss out on the in-person collaboration that drives innovation.
                  </p>
                  ...
                  <p>
                    You get the freedom to decide how to best set yourself up for success. Using the resources
                    established office spaces provide, you are now able to personalize your workspace to fit your goals.
                  </p>
                  <div class="d-flex align-items-center mb-2">
                    <i class="bi bi-check2"></i>
                    <h4>What does this mean for spaces?</h4>
                  </div>
                  <p>
                    As employees begin working from home, established spaces are left dormant. Supplying space for
                    individuals wanting to collaborate on their own terms provides the best of both worlds for all
                    involved.
                  </p>
                </div>
                <!-- End Tab 1 Content -->
